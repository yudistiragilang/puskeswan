    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Manage Staffs</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm" data-toggle="modal" data-target="#modalInput">Add Staff</button>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php foreach ($staffs as $x) : ?>
                                    <tr>
                                        <th scope="row"><?= $x['id']; ?></th>
                                        <td><?= $x['nik']; ?></td>
                                        <td><?= $x['staff_name']; ?></td>
                                        <td><?= $x['staff_address']; ?></td>
                        ...
                        <?= $pager->links('staffs', 'bootstrap_pagination'); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalInputLabel">Add Staff</h5>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('StaffsController/createStaff'); ?>" method="POST">
                    <?= csrf_field() ?>
                    ...
                    <div class="form-group">
                        <input type="text" name="nama" class="form-control form-control-user" id="nama" value="<?= old('nama'); ?>" placeholder="Staff name">
                    </div>
                    <div class="form-group">
                        <input type="text" name="alamat" class="form-control form-control-user" id="alamat" value="<?= old('alamat'); ?>" placeholder="Staff address">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" name="telepon" class="form-control form-control-user" id="telepon" value="<?= old('telepon'); ?>" placeholder="Staff telepone">
                    </div>
            </div>
...
<?php foreach ($staffs as $x) : ?>
    <div class="modal fade" id="modalUpdate<?= $x['id']; ?>" tabindex="-1" aria-labelledby="modalUpdateLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalUpdateLabel">Update Staff</h5>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('StaffsController/updateStaff'); ?>" method="POST">
                        <?= csrf_field() ?>
                        <div class="form-group">
                            <input type="text" name="nik" class="form-control form-control-user" id="nik" value="<?= $x['nik']; ?>" readonly>
                            <input type="text" value="<?= $x['id']; ?>" name="id_staff" hidden>
                        </div>

                        <div class="form-group">
                            <input type="text" name="nama" class="form-control form-control-user" id="nama" value="<?= $x['staff_name']; ?>">
                        </div>

                        <div class="form-group">
                            <input type="text" name="alamat" class="form-control form-control-user" id="alamat" value="<?= $x['staff_address']; ?>">
                        </div>
...
<?php foreach ($staffs as $x) : ?>
    <div class="modal fade" id="modalDelete<?= $x['id']; ?>" tabindex="-1" aria-labelledby="modalDeleteLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalDeleteLabel">Delete Staff</h5>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('StaffsController/deleteStaff'); ?>" method="POST">
                        <?= csrf_field() ?>
                        <div class="form-group">
                            <p>Are you sure want to delete staff data NIK <?= $x['nik']; ?> ?</p>
                            <input type="text" value="<?= $x['id']; ?>" name="id_staff" hidden>
                        </div>
                </div>
                <div class="modal-footer">
