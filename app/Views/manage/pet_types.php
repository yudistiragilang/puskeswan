    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Manage Pet Types</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm" data-toggle="modal" data-target="#modalInput">Add Pet Type</button>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        ...
                        <?= $pager->links('pet_types', 'bootstrap_pagination'); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalInputLabel">Add Pet Type</h5>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('PetTypesController/createPetType'); ?>" method="POST">
                    <?= csrf_field() ?>
...
<?php foreach ($pet_types as $x) : ?>
    <div class="modal fade" id="modalUpdate<?= $x['id']; ?>" tabindex="-1" aria-labelledby="modalUpdateLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalUpdateLabel">Update Pet Type</h5>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('PetTypesController/updatePetType'); ?>" method="POST">
                        <?= csrf_field() ?>
                        <div class="form-group">
                            <input type="text" name="description" class="form-control form-control-user" id="description" value="<?= $x['description']; ?>">
                            <input type="text" value="<?= $x['id']; ?>" name="id_pet_type" hidden>
                        </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
<?php foreach ($pet_types as $x) : ?>
    <div class="modal fade" id="modalDelete<?= $x['id']; ?>" tabindex="-1" aria-labelledby="modalDeleteLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalDeleteLabel">Delete Pet Type</h5>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('PetTypesController/deletePetType'); ?>" method="POST">
                        <?= csrf_field() ?>
                        <div class="form-group">
                            <p>Are you sure want to delete data pet type <?= $x['description']; ?> ?</p>
                            <input type="text" value="<?= $x['id']; ?>" name="id_pet_type" hidden>
                        </div>
                </div>
                <div class="modal-footer">
