...
class PetsModel extends Model
{
    ...
    {
        if ($pager != null) {
            $builder = $this->select('pets.id, pets.dob, pets.pets_name, pets.pets_owner, z.owner_name, pets.pet_type, pets.gander, x.description AS type, pets.breed, c.breed AS breed_desc');
